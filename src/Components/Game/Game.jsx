...
let box_array =[box1,box2,box3,box4,box5,box6,box7,box8,box9]
  ...
  const won = (winner) => {
    setLock(true);
    if (winner === "x") {
      titleRef.current.innerHTML = `Congratulations:<span class="img">Circle </spam> Wins`;
    }
    else{
      titleRef.current.innerHTML = `Congratulations: <span class="img">Cross  </spam>  Wins`;
    }
  };
  ...
  const reset = () =>
  {
    setLock(false);
    data =["","","","","","","","",""];
    titleRef.current.innerHTML = `Playing Game  With <span>Mirza</span>`
    box_array.map((e)=>{
      e.current.innerHTML = "";
    })
  }
